    ...
    <div className='m-5'>
      ...
      <div className='flex flex-wrap gap-3'>
        <div className='flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 transition-all'>
          <img className='w-14' src={assets.product_icon} alt="" />
          <div>
            <p className='text-xl font-semibold text-gray-600'>{dashData.product}</p>
        ...
        <div className='flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 transition-all'>
          ...
          <div>
            ...
            <p className='text-gray-400'>Usuarios</p></div>
        </div>
      </div>
